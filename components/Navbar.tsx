    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        <div
          ...
          className="flex w-6 h-5 flex-col justify-between items-center mdl:hidden text-4xl text-textGreen cursor-pointer overflow-hidden group">
        ...
        <a href='https://github.com/fullstacksherpa' target='_blank'>
            <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
              ...
              className='text-sm w-72 tracking-widest text-textGreen text-center mt-4' href="mailto:fullstacksherpa@gmail.com"
              ><p>fullstacksherpa@gmail.com</p></motion.a>
            </motion.div>
          </div>
        )}
      </div>
