...
const Banner = () => {
  return (
    <section id='home' className='max-w-contentContainer mx-auto py-10 mdl:py-24 flex flex-col gap-4 lgl:gap-8 mdl:px-10 xl:px-4'>
         ...
         Explore my journey as I craft seamless user experiences with Next.js and dive into the limitless possibilities of Node.js for robust backend solutions.
         <a href='https://ongchen.com'><span className='text-textGreen inline-flex relative cursor-pointer h-7 overflow-x-hidden group'>Learn More
